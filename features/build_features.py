...
def create_database():
    ...
    conn.executescript("""
        CREATE TABLE feature_store (
            ...
            num__temperature_c REAL,
            num__precipitation_mm REAL,
            num__wind_speed_kmh REAL,
            num__visibility_km REAL,
            num__weather_data_available REAL,
    ...
    metadata = [
        ...
        ("num__temperature_c", "numeric", "Hourly temperature in Celsius"),
        ("num__precipitation_mm", "numeric", "Hourly precipitation in millimetres"),
        ("num__wind_speed_kmh", "numeric", "Hourly wind speed in kilometres per hour"),
        ("num__visibility_km", "numeric", "Hourly visibility in kilometres"),
        ("num__weather_data_available", "binary", "Whether weather observations matched pickup hour"),
